                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nombre" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" value="{{ $especialidad->nombre }}" autocomplete="off">
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-primary" action="{{ route('admin.especialidades.update', $especialidad->id) }}">
                                                    Editar
                                                </button>
                                            </div>
