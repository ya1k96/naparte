        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-form">
                    <a href="{{route('admin.inventario.descargarEjemplo')}}" class="btn btn-dark" escape="false"><i class="fa fa-download"></i> Plantilla Ejemplo</a>
                </div>
            </div>

            <form action="{{ route('admin.inventario.importarStore') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        <div class="col-5">
                            ...
                            <select name="bases_operacion_id" class="form-control select2" data-placeholder="Seleccione una Base de Operación" required>
