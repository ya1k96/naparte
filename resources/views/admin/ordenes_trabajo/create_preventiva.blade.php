                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Nueva orden de trabajo Preventiva</h4>
                        </div>
                        <form action="{{ route('admin.ordenes-trabajo.storePreventiva') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            <input type="hidden" name="_token" value="{{ Session::token() }}">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="input-group">
                                            <select name="unidad_id" id="unidad_id" class="form-control select2 {{ $errors->has('unidad_id') ? ' is-invalid' : '' }} buscar_tareas" data-placeholder="Selecciona una unidad" required>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="input-group">
                                            <select name="especialidad_id[]" id="especialidad_id" class="form-control select2 {{ $errors->has('especialidad_id') ? ' is-invalid' : '' }} buscar_tareas" data-placeholder="Selecciona una especialidad" multiple required>
                                                <option label="Selecciona una especialidad" value="">Selecciona una especialidad</option>
                                                @foreach ($especialidades as $especialidad)
                                                    <option value="{{$especialidad->id}}" {{ (old('especialidad_id') == $especialidad->id) ? 'selected' : '' }}>{{$especialidad->nombre}}</option>
                                                @endforeach
                                                <option label="Todas" value="todas" {{ (old('especialidad_id') == 'todas') ? 'selected' : '' }}>Todas</option>
                                            </select>
                                            <div class="invalid-feedback">
                            ...
                            <div class="card-header">
                                <h4>Tareas para la especialidad</h4>
                            </div>
                            <div class="card-body">
                                <div class="tareas">
                                    <small>Seleccione una unidad para visualizar las tareas.</small>
                                </div>
                            </div>
